    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal" data-target="#adminModal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" data-target="#adminModal">Close</button>
                <button type="submit" class="btn btn-primary saveAdmin">Save</button>
            </div>
        </div>
    </div>
</div>
